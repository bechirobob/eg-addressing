...
| `administrative_unit_version.lifecycle_state` | Version lifecycle state. | text | no | 'active' | — | lifecycle_state | Registry Authority | government-internal | "operator" | current fact | — |
...
| `building.lifecycle_state` | Building lifecycle. | text | no | — | — | reference_object_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
...
| `locality.lifecycle_state` | Locality lifecycle. | text | no | — | — | reference_object_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
...
| `location_record_version.lifecycle_state` | Registry lifecycle state for this version. | text | no | — | — | canonical_record_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
...
| `operational_area.lifecycle_state` | Operational area lifecycle. | text | no | — | — | operational_area_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
...
| `road.lifecycle_state` | Road lifecycle. | text | no | — | — | reference_object_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
...
| `road_segment.lifecycle_state` | Segment lifecycle. | text | no | — | — | reference_object_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
...
| `unit.lifecycle_state` | Unit lifecycle. | text | no | — | — | reference_object_lifecycle | Registry Authority | government-internal | "operator" | current fact | — |
