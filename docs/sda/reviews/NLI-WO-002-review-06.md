...
|---|---|---|---|---|
| F02 | Resolved for SDA Review 07: controlled maps corrected to observed source values and target vocabularies; references have exact source/target crosswalk joins; pseudo assertions replaced by executable transform checks. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F04 | Resolved for SDA Review 07: record/object cardinality matrix is keyed by actual canonical record types with min/max/required role enforcement. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F05 | Resolved for SDA Review 07: alias, version and geometry supersession rules include no-self, reciprocal, same-owner and acyclic checks plus recorded-time cataloguing. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F06 | Resolved for SDA Review 07: geometry promotion requires authorized decision, evidence object, authority scope, accepted quality, and same-subject/role supersession. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F07 | Resolved for SDA Review 07: all lifecycle graphs are loaded into executable transition policy with reachability, terminality and edge metadata validation. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F08 | Resolved for SDA Review 07: route policies are corrected against method, path, operation id, handler, source span, auth mode and roles; dynamic contracts enumerate concrete fields. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F09 | Resolved for SDA Review 07: migration units rebuilt only from accepted executable transformation groups with dependency order, FK outputs and executable validation. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F10 | Resolved for SDA Review 07: scenario builders include scenario-specific records, histories and expected operator/public projections. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F11 | Resolved for SDA Review 07: ADRs reconciled to named passing assertions and open RFIs; stale Review 05 status removed. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F12 | Resolved for SDA Review 07: semantic CI detects each Review 06 defect class and reports named executable assertions only. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
| F13 | Resolved for SDA Review 07: migration-ledger runtime fix moved to maintenance PR #8 and PR #7 restored to design-only scope. | `REVIEW06_FIXING_COMMIT_PENDING`; evidence: Review 07 semantic assertions, design consistency report, target schema validation, route/projection registries, scenario expectations, ADR assertion matrix and exact-head CI. | READY FOR SDA REVIEW | 2026-07-14 |
